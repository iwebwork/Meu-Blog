				...
				<div class="archive-header-inner">
					...
					<?php if ( is_search() ) :
						...
						<div class="archive-description">
							...
							printf( _nx( 'Foi encontrado %s resultados da sua pesquisa.', 'Found %s results matching your search.',$wp_query->found_posts, '%s = number of results', 'koji' ), $wp_query->found_posts ); ?></p>
