...
function materialis_get_footer_copyright()
{
    ...
    $copyright = '<p ' . $previewAtts . ' class="copyright">&copy;&nbsp;' . "&nbsp;" . date_i18n(__('Y', 'materialis')) . '&nbsp;' . esc_html(/*get_bloginfo('name')*/' - Igor Siqueira da Silva') . '.&nbsp;' . wp_kses_post($copyrightText) . '</p>';
